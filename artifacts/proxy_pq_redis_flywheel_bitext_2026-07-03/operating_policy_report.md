...
| balanced_validated_pq | lattice_pq_validated_cosine | 0.9663 | 0.0338 | 0.0000 | 0.0000 | Target product path: PQ candidate generation with validation before serving. |
| aggressive_raw_pq | lattice_pq_local | 1.0000 | 0.0000 | 0.0338 | 0.1500 | Research/high-risk mode only; raw PQ can over-hit and must carry FP metrics. |
