/* @ts-self-types="./latticememory_kernel.d.ts" */
 ...
 * @returns {Uint8Array}
 */
export function snap_embeddings(embeddings, d_model) {
    const ptr0 = passArrayF32ToWasm0(embeddings, wasm.__wbindgen_malloc);
    const len0 = WASM_VECTOR_LEN;
    const ret = wasm.snap_embeddings(ptr0, len0, d_model);
...
function __wbg_get_imports() {
    ...
    return {
        __proto__: null,
        "./latticememory_kernel_bg.js": import0,
    };
}
...
async function __wbg_init(module_or_path) {
    ...
    if (module_or_path === undefined) {
        module_or_path = new URL('latticememory_kernel_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
